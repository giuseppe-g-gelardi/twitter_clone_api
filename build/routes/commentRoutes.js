...
router.post('/:username/:postid/comments/:commentid/replies', commentController_1.reply);
router.get('/:username/:postid/comments/:commentid/replies', commentController_1.getAllReplies);
